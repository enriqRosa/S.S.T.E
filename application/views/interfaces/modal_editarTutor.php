                ...
                <?php   if(isset($mostrardatosTutor)){?>
                    <div class="c-inputs-4" >
                        ...
                        <div class="mdl-textfield mdl-js-textfield ">
                            <input class="mdl-textfield__input" type="text" name="matricula" value="<?php echo $mostrardatosTutor[0]->matricula;?>" required>
                        ...
                        <div class="c-inputs-4">
                            ...
                            <div class="mdl-textfield mdl-js-textfield ">
                                <input class="mdl-textfield__input" type="text" name="nombre" value="<?php echo $mostrardatosTutor[0]->nombre;?>" required>
                        ...
                        <div class="form-icons"><i class="fas fa-user"></i></div>
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" name="ap_paterno" value="<?php echo $mostrardatosTutor[0]->ap_paterno;?>" required>
                        ...
                        <div class="c-inputs-4">
                            <div class="form-icons"><i class="fas fa-user"></i></div>
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" name="ap_materno" value="<?php echo $mostrardatosTutor[0]->ap_materno;?>" required required>
                        ...
                        <div class="c-inputs-4">
                            ...
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" name="correo" value="<?php echo $mostrardatosTutor[0]->correo;?>" required required>
                        ...
                        <div class="c-inputs-4">
                            ...
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" name="telefono" value="<?php echo $mostrardatosTutor[0]->telefono;?>" required required>
