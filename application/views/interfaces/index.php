...
<head>
    ...
    <body id="page">
        ...
        <div id="main-section">
            ...
            <?php echo form_open('paginas/proceso_login','class="main-form"'); ?>
                <!--<form class="main-form">-->
                    ...
                    <div class="c-inputs">
                        ...
                        <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" onclick="login()">Login</button>
                    <?php if(isset($error)){
                            echo $error;
                            } 
                    ?>
