<?php echo form_open("Admin/actualizarCoord"); ?>  
                ...
                <?php if(isset($mostrardatosCoord)){?>
                    <div class="c-inputs-4" >
                        ...
                        <div class="mdl-textfield mdl-js-textfield ">
                            <input class="mdl-textfield__input" type="text" name="matricula" value=" <?php echo $mostrardatosCoord[0]->matricula;?>" required>
                    ...
                    <div class="c-inputs-4">
                        ...
                        <div class="mdl-textfield mdl-js-textfield ">
                            <input class="mdl-textfield__input" type="text" name="nombre" value=" <?php echo $mostrardatosCoord[0]->nombre;?>" required>
                    ...
                    <div class="c-inputs-4">
                        <div class="form-icons"><i class="fas fa-user"></i></div>
                        <div class="mdl-textfield mdl-js-textfield">
                            <input class="mdl-textfield__input" type="text" name="ap_paterno" value="<?php echo $mostrardatosCoord[0]->ap_paterno;?>" required>
                    ...
                    <div class="c-inputs-4">
                        <div class="form-icons"><i class="fas fa-user"></i></div>
                        <div class="mdl-textfield mdl-js-textfield">
                            <input class="mdl-textfield__input" type="text" name="ap_materno" value=" <?php echo $mostrardatosCoord[0]->ap_materno;?>" required>
                    ...
                    <div class="c-inputs-4">
                        ...
                        <div class="mdl-textfield mdl-js-textfield">
                            <input class="mdl-textfield__input" type="text" name="correo" value="<?php echo $mostrardatosCoord[0]->correo;?>" required required>
                    ...
                    <div class="c-inputs-4">
                        ...
                        <div class="mdl-textfield mdl-js-textfield">
                            <input class="mdl-textfield__input" type="text" name="telefono" value="<?php echo $mostrardatosCoord[0]->telefono;?>" required required>
                    ...
                    <div class="c-inputs-4">
                        ...
                        <div class="c-inputs-4">         
                            ...
                            <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-1">
                                <input type="radio" id="option-1" class="mdl-radio__button" name="status" value="INACTIVO" required required>
                                <span class="mdl-radio__label tajawalR ls2">Inactivo</span>
                            </label> 
                            <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-2">
                                <input type="radio" id="option-2" class="mdl-radio__button" name="status" value="ACTIVO" required required>
                                <span class="mdl-radio__label tajawalR ls2">No Cambiar</span>
                            </label>         
                        </div>      
                        <div class="c-inputs-4">
                            <?php }if($mostrardatosCoord[0]->status=='INACTIVO'){
                                    foreach ($mostrardatosCoord as $row) {  ?>       
                                        <span class="fs19 ls2 tajawalB"><?php echo $row->status; ?></span>  
                                    <?php } ?>
                        </div>
