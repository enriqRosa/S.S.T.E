            ...
            <div class="modal-info-5">
                ...
                <div class="c-inputs-4" >
                    <?php foreach ($mostrardatosTutorado as $mostrar) { ?>
                        <span class="mdl-dialog__title fs18 tajawalR ls1">Matricula Tutorado:</span>
                            <input class="fs16 tajawalB ls1" type="text" name="matricula" value="<?php echo $mostrar->matricula;?>">
                    <?php }?>
                </div>
                <div class="c-inputs-4">
